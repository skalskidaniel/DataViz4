...
def create_price_distribution():
    ...
    return dbc.Row([
                html.H3("Price distribution by the type of alcohol"),
                html.Hr(),
                html.P("The price distribution had been limited to values below 200 USD to ensure clarity in the visualization. However wines and spirits can be found at much higher prices (even around 40000USD)"),
                html.P("The most pricy are spirits, and the least is beer which sounds reasonable."),
                dcc.Graph(
